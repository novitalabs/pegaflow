...
- `--enable-lfu-admission`: Enable W-TinyLFU cache admission policy (default: plain LRU)
- `--lfu-window-ratio`: Admission window size as a percentage of the pinned-memory pool (default: `1.0`, valid range: `0 < ratio < 100`)
