...
class PdRdmaEngine:
    ...
    def pull_layer(self, req_id: str, layer_idx: int, blocks: list[dict]) -> None: ...
    def pull_layers(self, req_id: str, layers: list[tuple[int, list[dict]]]) -> None: ...
    def wait_for_pulls(self, req_id: str) -> None: ...
    def push_done(self, req_id: str) -> None: ...
    def write_stats(self, req_id: str) -> dict: ...
    def read_stats(self, req_id: str) -> dict: ...
