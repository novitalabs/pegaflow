...
class PegaRdmaV1Engine:
    ...
    def get_or_prepare(self, remote_addr: str) -> PegaRdmaV1Handshake: ...
    def local_meta_for(self, remote_addr: str) -> bytes | None: ...
    def complete_handshake(
        self,
        remote_addr: str,
        local_metadata: bytes,
        remote_metadata: bytes,
    ) -> None: ...
    def abort_handshake(self, remote_addr: str, local_metadata: bytes) -> None: ...
    def register_blocks_table(self, blocks: list[tuple[int, int, int]]) -> int: ...
    def drop_blocks_table(self, handle: int) -> None: ...
    def read_async(self, remote_addr: str, descs: list[dict[str, int]]) -> int: ...
    def read_async_indices(
        self,
        remote_addr: str,
        local_table_handle: int,
        remote_table_handle: int,
